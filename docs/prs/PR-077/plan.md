...
- This PR must leave [docs/prs/PR-077/plan.md](/docs/prs/PR-077/plan.md) in place before merge.

## output summary
- Add [docs/prs/PR-077/plan.md](/docs/prs/PR-077/plan.md) as the PR-local contract and snapshot note.
- Add [docs/prs/PR-077/proposal.md](/docs/prs/PR-077/proposal.md) as the apply behavior proposal.
